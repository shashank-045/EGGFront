...
const AddNewOutlet = () => {
  ...
  useEffect(() => {
    ...
    fetch('http://eb-trial.onrender.com/egg-bucket-b2b/get-all-outlets')
    ...
    fetch(
      'http://eb-trial.onrender.com/outletPartners/egg-bucket-b2b/displayAll-outlet_partner'
    )
      .then((response) => response.json())
      .then((data) => {
        if (data.status === 'success') {
    ...
    fetch(
      'http://eb-trial.onrender.com/deliveryDrivers/egg-bucket-b2b/displayAll-delivery_partner'
    )
      .then((response) => response.json())
      .then((data) => {
  ...
  const handleSubmit = (e) => {
    ...
    fetch('http://eb-trial.onrender.com/egg-bucket-b2b/create-outlet', {
      method: 'POST',
      body: formDataToSend,
    })
      .then((response) => response.json())
