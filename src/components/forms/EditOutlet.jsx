...
const EditOutlet = ({ outlet, onClose, onSave }) => {
  ...
  useEffect(() => {
    const fetchOutletPartners = async () => {
      try {
        const response = await fetch('http://eb-trial.onrender.com/outletPartners/egg-bucket-b2b/displayAll-outlet_partner');
    ...
    const fetchDeliveryPartners = async () => {
      try {
        const response = await fetch('http://eb-trial.onrender.com/deliveryDrivers/egg-bucket-b2b/displayAll-delivery_partner');
