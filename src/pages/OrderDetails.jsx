...
const OrderDetails = () => {
    ...
    const fetchOutlets = async () => {
      try {
        const response = await fetch(
          "http://eb-trial.onrender.com/egg-bucket-b2b/get-all-outlets"
        );
  ...
  useEffect(() => {
    const fetchCustomers = async () => {
      try {
        const response = await fetch(
          "http://eb-trial.onrender.com/customers/egg-bucket-b2b/getAllCustomer"
        );
        const data = await response.json();
        if (data) {
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        const response = await fetch(
          "http://eb-trial.onrender.com/orders/egg-bucket-b2b/getAllOrder"
        );
        const data = await response.json();
  ...
  useEffect(() => {
    const fetchFilteredOrders = async () => {
      let url = "http://eb-trial.onrender.com/orders/egg-bucket-b2b/getAllOrder";
      const filters = [];
